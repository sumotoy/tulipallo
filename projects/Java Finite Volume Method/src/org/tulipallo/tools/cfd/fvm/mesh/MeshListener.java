...
import org.tulipallo.tools.cfd.ExceptionListener;
 ...
 * @version 1.0 beta
 */
public interface MeshListener extends ExceptionListener {
    public void handleMeshCompleted(MeshEvent event);
}
