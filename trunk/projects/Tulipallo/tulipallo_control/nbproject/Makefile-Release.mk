...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libtulipallo_control.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libtulipallo_control.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -shared -fPIC

${OBJECTDIR}/Attitude.o: Attitude.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/Attitude.o Attitude.cpp

${OBJECTDIR}/BaseSituation.o: BaseSituation.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/BaseSituation.o BaseSituation.cpp

${OBJECTDIR}/ControlSurfacePosition.o: ControlSurfacePosition.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/ControlSurfacePosition.o ControlSurfacePosition.cpp

${OBJECTDIR}/IControlSurface.o: IControlSurface.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/IControlSurface.o IControlSurface.cpp

${OBJECTDIR}/IGPS.o: IGPS.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/IGPS.o IGPS.cpp

${OBJECTDIR}/IGyro.o: IGyro.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/IGyro.o IGyro.cpp

${OBJECTDIR}/ISituation.o: ISituation.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/ISituation.o ISituation.cpp

${OBJECTDIR}/ISlipIndicator.o: ISlipIndicator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/ISlipIndicator.o ISlipIndicator.cpp

${OBJECTDIR}/PIDAttitude.o: PIDAttitude.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/PIDAttitude.o PIDAttitude.cpp

${OBJECTDIR}/PIDController.o: PIDController.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/PIDController.o PIDController.cpp
...
${OBJECTDIR}/Slip.o: Slip.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/Slip.o Slip.cpp

${OBJECTDIR}/Yaw.o: Yaw.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/Yaw.o Yaw.cpp
