...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libtulipallo_xplane.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libtulipallo_xplane.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -shared -fPIC

${OBJECTDIR}/ControlSurfaceFactory.o: ControlSurfaceFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/ControlSurfaceFactory.o ControlSurfaceFactory.cpp

${OBJECTDIR}/ControlSurfaceSentence.o: ControlSurfaceSentence.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/ControlSurfaceSentence.o ControlSurfaceSentence.cpp

${OBJECTDIR}/ISentenceListener.o: ISentenceListener.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/ISentenceListener.o ISentenceListener.cpp

${OBJECTDIR}/InvalidMessageException.o: InvalidMessageException.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/InvalidMessageException.o InvalidMessageException.cpp

${OBJECTDIR}/LocationFactory.o: LocationFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/LocationFactory.o LocationFactory.cpp

${OBJECTDIR}/LocationSentence.o: LocationSentence.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/LocationSentence.o LocationSentence.cpp

${OBJECTDIR}/MarshallingException.o: MarshallingException.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/MarshallingException.o MarshallingException.cpp

${OBJECTDIR}/MessageHandler.o: MessageHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/MessageHandler.o MessageHandler.cpp

${OBJECTDIR}/MessageReciever.o: MessageReciever.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/MessageReciever.o MessageReciever.cpp

${OBJECTDIR}/MessageTransmitter.o: MessageTransmitter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/MessageTransmitter.o MessageTransmitter.cpp

${OBJECTDIR}/SentenceFactory.o: SentenceFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/SentenceFactory.o SentenceFactory.cpp

${OBJECTDIR}/SentenceReceivedEvent.o: SentenceReceivedEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/SentenceReceivedEvent.o SentenceReceivedEvent.cpp

${OBJECTDIR}/SituationFactory.o: SituationFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/SituationFactory.o SituationFactory.cpp

${OBJECTDIR}/SituationSentence.o: SituationSentence.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/SituationSentence.o SituationSentence.cpp

${OBJECTDIR}/SlipFactory.o: SlipFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/SlipFactory.o SlipFactory.cpp

${OBJECTDIR}/SlipSentence.o: SlipSentence.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/SlipSentence.o SlipSentence.cpp

${OBJECTDIR}/SpeedFactory.o: SpeedFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/SpeedFactory.o SpeedFactory.cpp

${OBJECTDIR}/SpeedSentence.o: SpeedSentence.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/SpeedSentence.o SpeedSentence.cpp

${OBJECTDIR}/XPlaneSentence.o: XPlaneSentence.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/XPlaneSentence.o XPlaneSentence.cpp
