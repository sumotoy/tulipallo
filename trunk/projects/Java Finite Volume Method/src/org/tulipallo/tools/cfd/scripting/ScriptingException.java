...
public class ScriptingException extends RuntimeException {
    ...
    public ScriptingException(final Throwable cause, final Script script) {
        super(cause);
        this.script = script;
    }
    ...
    public ScriptingException(final String message, final Script script) {
        super(message);
        this.script = script;
    }

    public ScriptingException(final Script script) {
        this.script = script;
    }
